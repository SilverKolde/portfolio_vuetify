  ...
  state: {
    projects: [
      ...
      new Project(
          ...
          "Solo Project",
          "An app that visualizes how disks get fragmented. Although SSDs are replacing HDDs in fast pace, HDDs are still widely used and will be in the future too.",
